  ...
  getOffers() {
    if (isOnline()) {
      return this._api.getOffers()
        .then((offers) => {
          this._store.setAnotherItem(`offers`, offers);

          return offers;
        });
    }

    const storeOffers = this._store.getAnotherItem(`offers`);
  ...
  getDestinations() {
    if (isOnline()) {
      return this._api.getDestinations()
        .then((destinations) => {
          this._store.setAnotherItem(`destinations`, destinations);

          return destinations;
        });
    }

    const storeDestinations = this._store.getAnotherItem(`destinations`);
